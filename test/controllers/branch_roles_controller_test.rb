...
class BranchRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_role" do
    assert_difference('BranchRole.count') do
      post branch_roles_url, params: { branch_role: { receiver_id: @branch_role.receiver_id, sender_id: @branch_role.sender_id } }, as: :json
    end
  ...
  test "should update branch_role" do
    patch branch_role_url(@branch_role), params: { branch_role: { receiver_id: @branch_role.receiver_id, sender_id: @branch_role.sender_id } }, as: :json
    assert_response 200
  end
